...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header id="main-header" class="bg-auto bg-fixed bg-center font-lato max-h-screen max-w-full md:bg-cover" data-svelte-h="svelte-1cj0y1k"><div class="container mx-auto"><div class="flex flex-col justify-center items-center py-14 px-10 md:py-24 md:px-20"><img id="logo"${add_attribute("src", FaisalLogo, 0)} alt="Faisal Logo" class="w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] md:w-[500px] md:h-[500px]" loading="lazy"></div></div></header> <section id="personal-info" class="bg-light font-lato min-h-screen max-w-full border-0 md:border-b border-gray-100"><div class="container mx-auto"><div class="flex flex-col space-y-4 py-8 px-4 sm:py-16 sm:px-8 md:py-32 md:px-16 md:space-y-6 lg:py-48 lg:px-32 lg:space-y-8"><div id="personal-info-inner-box" class="flex flex-col justify-center items-center space-y-6 p-6 bg-light rounded-lg sm:p-7 md:p-8 lg:p-10" data-svelte-h="svelte-56p0oc"><h1 id="my-name" class="text-slide title text-3xl text-wrap font-bold tracking-normal text-gray-950 self-start sm:text-4xl md:text-6xl lg:text-8xl">Faisal Ramadhan</h1> <p id="my-profile-desc" class="text-slide description text-base font-normal leading-relaxed text-gray-950 self-start sm:text-base md:text-lg lg:text-xl">I am an Entry Level <a id="first-popover"${add_attribute("href", "#", 0)} class="underline underline-offset-2 font-semibold">Fullstack Developer</a> with a strong focus on achieving results, have leading expertise in analyzing, designing
					...
					application development, optimizing REST API performance, and database management.</p></div> <div class="flex flex-row space-x-4 justify-start items-center w-full px-6 sm:px-7 md:px-8 lg:px-10" data-svelte-h="svelte-wx10bf"><p class="text-lg font-normal underline underline-offset-2 sm:text-lg md:text-xl"><a id="resume-link"${add_attribute("href", "https://drive.google.com/file/d/1uO31SH5sbTrX3S4qfUruMWbVKIq4cMzV/view?usp=sharing", 0)} class="text-blue-500 hover:text-gray-900 transition-all duration-300 ease-in-out">View my resume</a></p> <p class="text-lg font-normal underline underline-offset-2 sm:text-lg md:text-xl"><a id="resume-link"${add_attribute("href", "https://drive.google.com/file/d/11TWun9yadb0_arylVdxmTbR6bnPLarW3/view?usp=sharing", 0)} class="text-blue-500 hover:text-gray-900 transition-all duration-300 ease-in-out">View my certificates</a></p></div> ${validate_component(Popover, "Popover").$$render(
    $$result,
    {
